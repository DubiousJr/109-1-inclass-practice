...
```{r ans11}
# newPromotion1 
category_f<-c("新登場","推薦套餐","豪華雙饗餐","牛丼類","咖哩類","豬肉丼類")
category<-factor(category_f)
newPromotion1<-list(
  category="新登場",
    item="番茄牛丼",
    description="新鮮蕃茄的酸味，讓人食慾大開！",
    price=109.00
 )
newPromotion1
str(newPromotion1)
...
# sukiyaMenu3
sukiyaMenu3<-list(
  list(catagory=c(sukiyaMenu[[1]][[1]],sukiyaMenu[[2]][[1]])),
  list(item=c(sukiyaMenu[[1]][[2]],sukiyaMenu[[2]][[2]])),
   list(item=c(sukiyaMenu[[1]][[3]],sukiyaMenu[[2]][[3]])),
  list(price=c(sukiyaMenu[[1]][[4]],sukiyaMenu[[2]][[4]]))
)
...
# sukiyaMenu4
sukiyaMenu4<-list(
  list(catagory=sukiyaMenu[[1]][[1]],
       opions=list(item=sukiyaMenu[[1]][[2]],
                   description=sukiyaMenu[[1]][[3]],
                   price=sukiyaMenu[[1]][[4]])),
  list(catagory=sukiyaMenu[[2]][[1]],
       options=list(item=sukiyaMenu[[2]][[2]],
                    description=sukiyaMenu[[2]][[3]],
                                                price=sukiyaMenu[[2]][[4]]))
)
str(sukiyaMenu4)
```
...
```{r ans22}
# totalAmount
teacher<-sukiyaMenu[[7]][[1]][[10]][[2]][[4]]
teachingAssistant<-sukiyaMenu[[8]][[2]][[10]][[1]][[4]]

totalAmount<-teacher+teachingAssistant
